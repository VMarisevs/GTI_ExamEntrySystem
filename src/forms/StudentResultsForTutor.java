...
/*
 * StudentResultsForTutor.java
 *
 * Created on 24-Feb-2013, 15:09:53
 */
 ...
 * @author Evilguy
 */
public class StudentResultsForTutor extends javax.swing.JInternalFrame {
    ...
    /** Creates new form StudentResultsForTutor */
    public StudentResultsForTutor() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btnSelectExam1 = new javax.swing.JButton();
        ...
        jScrollPane1.setBounds(220, 220, 270, 310);
        ...
        btnSelectExam.setBounds(400, 100, 100, 40);
        ...
        btnSelectExam1.setFont(new java.awt.Font("Tahoma", 0, 9));
        btnSelectExam1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/hd-search-icon.png"))); // NOI18N
        btnSelectExam1.setText("Exam");
        btnSelectExam1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnSelectExam1ActionPerformed(evt);
            }
        });
        getContentPane().add(btnSelectExam1);
        btnSelectExam1.setBounds(400, 150, 100, 40);

        pack();
    }// </editor-fold>//GEN-END:initComponents

    private void formInternalFrameActivated(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameActivated
        // getting all teacher's groups into list

        groupList = newConnection.getTutorGroupList(STARTME.glUser, STARTME.TESTING);
    ...
    private void btnSaveNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveNewActionPerformed
        // inserting a field into student result table
        if (!(txtExamResult.getText().isEmpty())){
    ...
    private void btnSelectGroupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSelectGroupActionPerformed
        // getting all the teacher's subjects and subject assignments
        ...
        subjectList = newConnection.getSubjectListFromGTS(groupList.get(cbGroup.getSelectedIndex()), STARTME.glUser, STARTME.TESTING);
    ...
    private void btnSelectExam1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSelectExam1ActionPerformed
...
}//GEN-LAST:event_btnSelectExam1ActionPerformed
    ...
    private javax.swing.JButton btnSelectExam1;
